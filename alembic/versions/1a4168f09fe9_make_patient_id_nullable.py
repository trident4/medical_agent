...
Revision ID: 1a4168f09fe9
Revises: 
Create Date: 2025-11-02 15:38:21.809610
...
# def downgrade() -> None:
    ...
    op.create_table('visits',
                    ...
                    sa.Column('visit_id', sa.VARCHAR(length=50),
                              autoincrement=False, nullable=False),
                    sa.Column('patient_id', sa.INTEGER(),
                              autoincrement=False, nullable=False),
                    sa.Column('visit_date', postgresql.TIMESTAMP(),
                              autoincrement=False, nullable=False),
                    sa.Column('visit_type', sa.VARCHAR(length=50),
                              autoincrement=False, nullable=False),
                    ...
                    sa.Column('treatment_plan', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('medications_prescribed', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('follow_up_instructions', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('doctor_notes', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('vital_signs', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('lab_results', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    ...
                    sa.ForeignKeyConstraint(
                        ['patient_id'], ['patients.id'], name='visits_patient_id_fkey'),
    ...
    op.create_table('patients',
                    sa.Column('id', sa.INTEGER(),
                              autoincrement=True, nullable=False),
                    sa.Column('patient_id', sa.VARCHAR(length=50),
                              autoincrement=False, nullable=False),
                    ...
                    sa.Column('date_of_birth', sa.DATE(),
                              autoincrement=False, nullable=False),
                    sa.Column('gender', sa.VARCHAR(length=20),
                              autoincrement=False, nullable=True),
                    ...
                    sa.Column('address', sa.TEXT(),
                              autoincrement=False, nullable=True),
                    sa.Column('emergency_contact', sa.VARCHAR(length=200),
                              autoincrement=False, nullable=True),
    ...
    op.create_index('ix_patients_patient_id', 'patients',
